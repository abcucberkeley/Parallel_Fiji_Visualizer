...
public class ParallelCompositeImage extends ParallelImagePlus {
	...
	public ParallelCompositeImage(ParallelImagePlus imp) {
		this(imp, COLOR);
	}
	
	public ParallelCompositeImage(ParallelImagePlus imp, int mode) {
